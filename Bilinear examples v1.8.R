...
source("~/Google Drive/Bilinear/Bilinear v1.8.5.R") # this will have to be changed to the directory where Bilinear v1.8.R lives on your computer!
load("soy.RData")
...
AMMIfit <- bilinear(x = Y)  # note this could take several minutes, as it is sampling 100,000 bootstraps with 1 cpu
